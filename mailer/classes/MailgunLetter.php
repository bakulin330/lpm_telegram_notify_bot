...
//                $template_data = str_replace ( "%var$i%", $this->variables[$i], $template_data );
//            }
...
//                $layout_data = file_get_contents(DIR_LAYOUTS . $this->layout . ".html");
//                $message = str_replace( "%template%", $template_data, $layout_data );
//            }
//        }
//
//        $post['html'] = $message;
